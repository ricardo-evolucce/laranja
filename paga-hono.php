...
action="https://pagseguro.uol.com.br/v2/checkout/payment.html" id="pag-form" name="pag-form">  
        ...
        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="claudia@laranja-marranghello.com.br">  
        ...
        <?php $valor = str_replace(',','.', str_replace('.','', $_POST['valor'])) ?>
        
        <input name="itemDescription1" type="hidden" value="<?php echo $_POST['descricao'];?>">  
        ...
        <input name="senderName" type="hidden" value="<?php echo $_POST['nome'];?>">  
