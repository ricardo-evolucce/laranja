            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid"><!-- 
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="title-1 m-b-25 text-center">Ver alunos inscritos</h3>
...
?>
                                            ...
                                            <tr>
                                                 <td><?php    echo $data_curso; ?></td>
                                                <td><a href="inscritos-no-curso.php?idCurso=<?php    echo $row['idCurso']; ?>"><?php    echo $row['nome']; ?> </a></td>
